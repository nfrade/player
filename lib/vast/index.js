...
module.exports = function (base, event) {
  var Observable = base.components.observable.Constructor
  var renderSrc = base.src.render
  var set = {}
  var define = set.define = {}
  ...
  define.playVideo = function (adStore, data, originalStamp) {
    ...
    data[this.progress.$].on((e, event) => {
      ...
      if (lastindex) {
        ...
        this.playAdRoll(adStore, this.config.ads[lastindex], data, originalStamp)
      }
    }, 'adProgress')
