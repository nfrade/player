...
//       elem.ended.origin.on((e, event) => {
//         if (e === true) {
//           // remove current ad from array
//           let currAdRoll = props.currAdRoll
//           if (currAdRoll) {
//             if (currAdRoll.length === 1) {
//               props.currAdRoll = null
//             } else {
//               currAdRoll.shift()
//             }
//             // if another ad in roll play that
//             if (!playNextAd(props, elem, state)) {
