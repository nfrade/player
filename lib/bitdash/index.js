  ...
  var settings = {
    ...
    events: {
      ...
      onAdStarted (a) {
        ...
        player.clickthroughUrl.set(a.clickthroughUrl, void 0)
        console.log('#AD STARTED!!!!!!!!!', player.clickthroughUrl.val)
      },
      onAdSkipped () {
        player.ad.origin.set(false)
        player.clickthroughUrl.set('', void 0)
        console.log('#AD SKIPPED !!!!!!!!!', player.clickthroughUrl.val)
      },
      onAdFinished () {
        player.ad.origin.set(false)
        player.clickthroughUrl.set('', void 0)
        console.log('#AD FINISHED !!!!!!!!!', player.clickthroughUrl.val)
      }
    }
  }
  if (adconfig) {
